      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className="mb-4">
          ...
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-teal-700 mb-3">
            Motivation-first payoff strategy
          </p>
        </div>

        <CalculatorIntro
          eyebrow="Debt Snowball Calculator"
          title="Start with the smallest win and build momentum."
          description="The snowball method is designed for people who need visible progress quickly. If motivation matters more than theoretical optimality, this is often the strategy that actually gets finished."
          bestFor="quick wins and staying consistent"
          highlights={["Smallest balance first", "One debt at a time", "Month-by-month payoff plan"]}
          asideTitle="What you’ll get"
          asideBody={
            <>
              Enter your balances, rates, and minimums once. DebtHydra will show you your
              debt-free timeline, total interest, and the payoff order that creates the classic
              snowball effect.
            </>
          }
        />
        ...
        <div className="mt-10 space-y-5">
          <Card padding="lg">
            ...
            <div className="prose text-sm">
              <p>
                The debt snowball method is simple: you pay off your <strong>smallest balance
                first</strong>, regardless of interest rate. Once that debt is gone, you take
                everything you were paying on it and roll it into the next-smallest debt.
              </p>
              <p>
              ...
              <p>
                ...
                <em>balance x monthly rate</em>), apply your minimum payments, and then throw any
          ...
          <Card padding="lg">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                ...
                timelines vary with fees, variable rates, and payment timing. Always verify with
                your lender.
              </li>
            </ul>
          </Card>
