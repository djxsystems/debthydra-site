...
The snowball is not the mathematically cheapest strategy. Every one of these people could have done the math and found a better rate to hit first.

But Priya had already tried that. Six months of the "optimal" plan, minimal progress, falling off the wagon repeatedly. When she switched to snowball, she put more money toward debt in the following months than she ever had under the avalanche — because she stayed on it.

That is the part the spreadsheet does not capture. Payoff speed assumes you execute the plan. The snowball's early wins make that more likely for most people.

If you want to see when each of your debts would disappear using the snowball method, put your actual numbers in the calculator.
