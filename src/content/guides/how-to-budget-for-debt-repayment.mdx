...
It will. An unexpected expense will hit, or you'll overspend one month, and the plan will feel wrecked.

The fix is the same every time: recalculate next month's extra payment with whatever you actually have, and keep going. The debt doesn't care why you missed a month. It just keeps charging interest. So does the payoff plan — it just keeps working when you do.
