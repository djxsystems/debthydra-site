...
import { calculateAvalanche, formatCurrency, formatMonths } from "@/lib/calculators";
...
export default function AvalancheCalculator() {
  ...
  function markStarted() {
    ...
    trackCalculatorStarted("avalanche", { debtCount: debts.length });
  }
  ...
  function calculate() {
    ...
    const calculation = calculateAvalanche(parsed, monthlyExtra);
    setResult(calculation);
    trackCalculatorCompleted("avalanche", {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="max-w-xs">
          <FormField
            ...
            hint="Extra cash you can apply on top of minimum payments each month."
            prefix="$"
            type="number"
            min={0}
            value={extraPayment}
      ...
      {result && (
        <div className="space-y-4">
          ...
          <Card>
            <h3 className="font-semibold text-gray-800 mb-2">Payoff Order (Avalanche)</h3>
            ...
            <p className="text-xs text-gray-500 mt-3">
              Highest interest rate tackled first — saves the most money overall.
            </p>
          </Card>
        </div>
      )}
